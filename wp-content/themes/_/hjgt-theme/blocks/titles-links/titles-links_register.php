<?php
        ...
        PG_Blocks_v2::register_block_type( array(
            'name' => 'tb-theme/titles-links',
            'title' => __( 'Title Non-Heading Link', 'tb_theme' ),
            'description' => __( 'A title link that does not have an h1, h2, etc tag.', 'tb_theme' ),
            ...
            'js_file' => 'blocks/titles-links/titles-links.js',
            'attributes' => array(
                'text_align' => array(
                    'type' => 'string',
            ...
            'example' => array(
'text_align' => 'justify-content-start', 'title_size' => 'h5', 'no_underline' => '', 'margin_bottom' => 'mb-1', 'show_arrow' => 'noArrow', 'full_width' => 'noFullWidth', 'title_url' => array('post_id' => 0, 'url' => 'filler', 'post_type' => '', 'title' => ''), 'link_open' => null, 'btn_text' => 'Here is a Title'
            ),
            'dynamic' => false,
            'version' => '1.0'
        ) );
