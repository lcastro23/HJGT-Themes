...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'tb-theme/object-fit-img', {
        apiVersion: 2,
        title: 'Card Image to Left',
        description: '',
        icon: 'block-default',
        category: 'custblocks',
        ...
        edit: function ( props ) {
            const blockProps = useBlockProps({ className: 'ojectFitImg', href: propOrDefault( props.attributes.url.url, 'url', 'url' ), onClick: function(e) { e.preventDefault(); } });
        ...
        save: function(props) {
            const blockProps = useBlockProps.save({ className: 'ojectFitImg', href: propOrDefault( props.attributes.url.url, 'url', 'url' ), onClick: function(e) { e.preventDefault(); } });
