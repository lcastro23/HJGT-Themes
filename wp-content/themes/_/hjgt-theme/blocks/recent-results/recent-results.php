<div <?php if(empty($_GET['context']) || $_GET['context'] !== 'edit') echo get_block_wrapper_attributes( array('class' => "ourBlogsCards", ) ); else echo 'data-wp-block-props="true"'; ?>> 
    ...
    ?>
    <?php $recent_query = new WP_Query( $recent_query_args ); ?>
    <div> 
            ...
            <div class="container"> 
                <div class="cardSimple padLG"> 
                    <div class="d-flex flexRow flexRowTitleAndLink fr_justify-content-center justify-content-between mb-2 mt-0 pb-0 pt-0 space1 wp-block-tb-theme-flex-row"> 
                        <div class="wp-block-tb-theme-titles text-center text-sm-left h3"> <span><?php _e( 'Recent Results', 'tb_theme' ); ?></span> 
                        </div>                         
                        <div class="wp-block-tb-theme-titles-links areaLink justify-content-center h5 mb-0 noArrow noFullWidth has-secondary-color has-text-color"> <a href="<?php echo esc_url( get_site_url().'/result/' ); ?>"><?php _e( 'See All', 'tb_theme' ); ?></a> 
                    ...
                    <?php if ( $recent_query->have_posts() ) : ?>
                        <div class="commingUpLoop recentPostsSimpleCard"> 
                            <?php $recent_query_item_number = 0; ?>
                            <?php while ( $recent_query->have_posts() ) : $recent_query->the_post(); ?>
                                <?php if( $recent_query_item_number >= 0 && $recent_query_item_number <= 3 ) : ?>
