<?php
        ...
        PG_Blocks_v2::register_block_type( array(
            'name' => 'tb-theme/horizon-nav-link-mega',
            'title' => __( 'Link with Constrained Mega Menu', 'tb_theme' ),
            ...
            'js_file' => 'blocks/horizon-nav-link-mega/horizon-nav-link-mega.js',
            'attributes' => array(
                'link_main_url' => array(
                    'type' => 'object',
            ...
            'example' => array(
'link_main_url' => array('post_id' => 0, 'url' => '', 'post_type' => '', 'title' => ''), 'link_main_text' => 'Link 1'
            ),
            'dynamic' => false,
