...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'tb-theme/horizon-nav-link-mega', {
        apiVersion: 2,
        title: 'Link with Constrained Mega Menu',
        description: '',
