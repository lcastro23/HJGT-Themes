...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'tb-theme/schedule-all-invitationals', {
        apiVersion: 2,
        title: 'All Invitationals',
        description: '',
        icon: 'block-default',
        category: 'custblocks',
        keywords: [],
        ...
        example: { attributes: { event_keyword: '' } },
        edit: function ( props ) {
            ...
            return el(Fragment, {}, [
                        ...
                        el( ServerSideRender, {
                            block: 'tb-theme/schedule-all-invitationals',
                            httpMethod: 'POST',
