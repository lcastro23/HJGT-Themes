...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'tb-theme/sml-img-slider', {
        apiVersion: 2,
        title: 'Small Images Slider',
        description: 'Slide icons or small logos across the screen.',
        ...
        edit: function ( props ) {
            ...
            const innerBlocksProps = useInnerBlocksProps({ className: 'smallImgSlider wrapper' }, {
                allowedBlocks: [ 'tb-theme/sml-img-box' ],
                template: [
    [ 'tb-theme/sml-img-box', {} ],
    [ 'tb-theme/sml-img-box', {} ],
    [ 'tb-theme/sml-img-box', {} ],
    [ 'tb-theme/sml-img-box', {} ],
    [ 'tb-theme/sml-img-box', {} ]
        ...
        save: function(props) {
            const blockProps = useBlockProps.save({ className: 'smallImgSliderWrapper' });
            return el('div', { ...blockProps }, [' ', ' ', el('div', { className: 'smallImgSlider wrapper' }, el(InnerBlocks.Content, { allowedBlocks: [ 'tb-theme/sml-img-box' ] })), ' ', ' ']);
        }                        
